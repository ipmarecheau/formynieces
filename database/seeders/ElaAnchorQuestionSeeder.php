...
/**
 * Slice 2c — ELA anchor question bank seeder.
 *
 * Loads authored ELA anchors from database/data/ela_anchor_bank.yaml into anchor_questions,
 ...
 */
class ElaAnchorQuestionSeeder extends Seeder
{
    private const SUBJECT = 'ELA';
    private const FILE = 'ela_anchor_bank.yaml';
