...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* animation leads; text is complementary */
        .hero-badge-center { display: block; width: max-content; max-width: 100%; margin: 0 auto 6px; }
        .hero-anim-lead { margin: 0 auto clamp(22px, 3.6vw, 34px); max-width: 880px; }
        .hero-lead-complement { max-width: 680px; }
        .hero-lead-complement h1 { font-size: clamp(23px, 3.6vw, 36px); margin-bottom: 16px; }
        .hero-lead-complement .hero-lede { font-size: clamp(15px, 1.95vw, 18px); margin-bottom: 24px; }
...
<section class="hero">
    <div class="wrap">
        ...
        <figure class="hero-anim hero-anim-lead" data-reveal style="--rd:.06s">
            <div class="stage">
...
<!-- TRY THE REAL APP (simulated front-end) -->
<section class="band" id="try-it">
    <div class="wrap">
        <div class="section-head" data-reveal>
            <span class="eyebrow">The real thing</span>
            <h2>Not a mock-up — the actual app.</h2>
            <p>These are real SmoothSeas screens, driven for you: sail the map, work a lesson, take the check, and watch Smooth's AI re-teach a missed rule right in the chat.</p>
        </div>
