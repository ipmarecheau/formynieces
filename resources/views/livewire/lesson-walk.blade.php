...
<style>
    ...
    .lw-title { font-family: 'Fredoka One', cursive; font-size: 21px; color: #67e8f9; margin: 0 0 18px; }
    .lw-no-lesson { font-size: 16px; color: rgba(196,181,253,0.85); margin-bottom: 18px; }
    .lw-para { font-size: 16.5px; line-height: 1.7; color: rgba(243,232,255,0.92); margin: 0 0 16px; }
    .lw-block-head { font-family: 'Fredoka One', cursive; font-size: 16px; color: #f0abfc; margin: 22px 0 10px; }
    .lw-example { background: rgba(34,211,238,0.06); border: 1.5px solid rgba(34,211,238,0.3); border-radius: 16px; padding: 16px 18px; margin: 0 0 16px; }
    .lw-example-tag, .lw-check-tag, .lw-key-tag { display: inline-block; font-family: 'Fredoka One', cursive; font-size: 12px; text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 8px; }
    .lw-example-tag { color: #67e8f9; }
    .lw-steps { margin: 8px 0 0 20px; display: flex; flex-direction: column; gap: 6px; color: rgba(243,232,255,0.92); font-size: 15.5px; line-height: 1.5; }
    .lw-key { background: rgba(246,183,30,0.12); border-left: 4px solid #f6b71e; border-radius: 10px; padding: 12px 16px; margin: 0 0 16px; font-size: 16px; color: #fde68a; line-height: 1.6; }
    .lw-key-tag { color: #f6b71e; display: block; }
    .lw-check { background: rgba(134,239,172,0.1); border-left: 4px solid #86efac; border-radius: 10px; padding: 12px 16px; margin: 0 0 16px; font-size: 16px; color: #bbf7d0; line-height: 1.6; }
