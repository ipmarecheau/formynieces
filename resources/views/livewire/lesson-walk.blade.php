...
<style>
    ...
    .lw-topic { font-family: 'Fredoka One', cursive; font-size: 26px; color: #e6f2fb; text-align: center; margin-bottom: 26px; }
    .lw-card { background: #0c2440; border: 1.5px solid rgba(34,211,238,0.35); border-radius: 24px; padding: 36px 30px; width: 100%; max-width: 600px; animation: lwFade 0.4s ease both; }
    @keyframes lwFade { from { opacity: 0; transform: translateY(12px); } to { opacity: 1; transform: translateY(0); } }
    .lw-section-head { font-family: 'Fredoka One', cursive; font-size: 16px; color: #67e8f9; margin: 0 0 12px; }
    ...
    .lw-resource { background: rgba(255,255,255,0.05); border: 1.5px solid rgba(34,211,238,0.3); border-radius: 14px; padding: 14px 18px; }
    .lw-resource a, .lw-resource span { color: #e6f2fb; font-size: 16px; font-weight: 600; text-decoration: none; }
