<div class="wl-wrap">
    {{-- Writing is a focus moment (a language assessment): Smooth waits quietly, no free chat. --}}
    <livewire:smooth-guide guide="writing" :locked="true" wire:key="guide-writing" />
    <style>
